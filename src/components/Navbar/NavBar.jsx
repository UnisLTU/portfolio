  ...
  return (
    <div className={styles.navbar_container} style={{ backgroundColor: navColor, transition: "all 0.5s" }} >
      ...
      <nav className={styles.navbar}>
        ...
        <Link className={styles.nav_buttons} to="home" spy={true} smooth={true} offset={-64} duration={500}><MdOutlineConnectWithoutContact size={20} style={{ padding: 2 }} /> Contact </Link>
